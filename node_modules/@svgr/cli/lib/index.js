...
async function run() {
  ...
  if (_commander.default.outDir && _commander.default.svgAttributes) {
    console.log(_chalk.default.yellow('--svg-attributes option is deprecated an will be removed in v3, please use --svg-props instead'));
  }
